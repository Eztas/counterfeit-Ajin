...
今回までの前身としてC++, C#で実装したものが存在し, Unityでも作ろうとしたが断念.

声で相手の動きを封じる設定があったのを思い出し, 音検知を経たこの技の実装を考えたが未だ未実装.

亜人の戦闘において一番重要である, 「自殺して全快すること」を再現した実装内容がボタンを押すだけの簡素なものになってしまったことに悩んでいる.
